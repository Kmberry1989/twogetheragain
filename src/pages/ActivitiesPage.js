...
const allActivitiesList = [
    { id: 'coin-toss', name: 'Coin Toss Challenge', componentName: 'CoinTossActivity', icon: DiceIcon, description: "A quick 3D coin toss!" },
    { id: 'collaborative-story', name: 'Our Story Unfolds', componentName: 'CollaborativeWritingActivity', icon: PenToolIcon, description: "Build a unique story together." },
    { id: 'song-creation', name: 'Duet Harmonies (Original)', componentName: 'SongCreationActivity', icon: MicIcon, description: "Record audio layers for a song." },
    { id: 'duet-harmonies-measures', name: 'Duet Harmonies (Measures)', componentName: 'DuetHarmoniesMeasuresActivity', icon: Music2Icon, description: "Layer short musical measures." },
    { id: 'scripted-scenes', name: 'Scripted Scenes', componentName: 'ScriptedScenesActivity', icon: MessageSquareIcon, description: "Voice act a script together." },
];
...
const ActivitiesPage = ({ onNavigate }) => {
 ...
 useEffect(() => {
  ...
  const activityComponents = { CoinTossActivity, CollaborativeWritingActivity, SongCreationActivity, DuetHarmoniesMeasuresActivity, ScriptedScenesActivity };
  const currentActivityDetails = currentActivity ? allActivitiesList.find(a => a.id === currentActivity.type) : null;
  const CurrentActivityComponent = currentActivityDetails ? activityComponents[currentActivityDetails.componentName] : null;
